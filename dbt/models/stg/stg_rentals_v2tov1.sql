...
with od as (
    select
        date_trunc('minute',
            to_timestamp(starttimems / 1000)::timestamptz at time zone 'America/Montreal'
        )::datetime as start_date,
        year(start_date) as year,
        startstationname,
        date_trunc('minute',
            to_timestamp(endtimems / 1000)::timestamptz at time zone 'America/Montreal'
...
from od
left join {{ ref("stg_stations_v2") }} as sta_start
